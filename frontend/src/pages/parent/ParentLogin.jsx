// ParentLogin.jsx - Parent-specific login flow with OTP/Password support and domain verification
  ...
  return (
    <div>
      <div style={{ textAlign: "center", marginBottom: 24 }}>
        ...
        <h1 style={s.heading}>Parent Portal</h1>
      ...
      <ActionButton color="#6D28D9" loading={loading} onClick={onSubmit}>
        Find School →
      </ActionButton>
    </div>
  );
...
function FormStep({
  ...
  return (
    <div>
      ...
      <p style={{ ...s.subheading, marginBottom: 18 }}>Track your child's academic journey</p>
